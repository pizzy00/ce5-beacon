...
const PRECACHE = [
  ...
  "./room.js?v=1",
  "./earthgl.js?v=1",
  "./vendor/peerjs/peerjs.min.js?v=1",
  "./audio/bridge.ogg",
  "./icon-192.png",
  "./icon-512.png",
  ...
  "./voice/guide-1.mp3", "./voice/guide-2.mp3", "./voice/guide-3.mp3", "./voice/guide-4.mp3", "./voice/guide-5.mp3", "./voice/guide-6.mp3", "./voice/sys-zeta.mp3", "./voice/sys-plei.mp3", "./voice/sys-siri.mp3", "./voice/sys-arct.mp3", "./voice/sys-vega.mp3", "./voice/sys-orio.mp3", "./voice/sys-andr.mp3", "./voice/sys-proc.mp3", "./voice/sys-drac.mp3", "./voice/sys-erid.mp3", "./voice/sys-acen.mp3",
  "./voice/f/guide-1.mp3", "./voice/f/guide-2.mp3", "./voice/f/guide-3.mp3", "./voice/f/guide-4.mp3", "./voice/f/guide-5.mp3", "./voice/f/guide-6.mp3", "./voice/f/sys-zeta.mp3", "./voice/f/sys-plei.mp3", "./voice/f/sys-siri.mp3", "./voice/f/sys-arct.mp3", "./voice/f/sys-vega.mp3", "./voice/f/sys-orio.mp3", "./voice/f/sys-andr.mp3", "./voice/f/sys-proc.mp3", "./voice/f/sys-drac.mp3", "./voice/f/sys-erid.mp3", "./voice/f/sys-acen.mp3",
  "./pursue.json",
  "./uso.json",
